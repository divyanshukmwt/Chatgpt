...
const Home = () => {
  ...
  const handleNewChat = async () => {
    ...
    const response = await axios.post("https://chatgpt-0lj9.onrender.com/api/chat", {
      title
    }, {
  ...
  useEffect(() => {
    ...
    axios.get("https://chatgpt-0lj9.onrender.com/api/chat", { withCredentials: true })
      .then(response => {
  ...
  const getMessages = async (chatId) => {
   ...
   const response = await  axios.get(`https://chatgpt-0lj9.onrender.com/api/chat/messages/${chatId}`, { withCredentials: true })
